        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="sistem/img/logo2.png" alt="apotek" width="100px" class="d-inline-block align-text-center" />
                </a>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/toko-allproduk') }}">Produk</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div style="margin: 50px 0 20px 70px;">
                            ...
                            <p>Jalan Jendral Sudirman No. 6A RT 01 RW 09 Planjan, Kecamatan Kesugihan, Kab. Cilacap, Provinsi
                                Jawa Tengah</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="map" style="margin-top: 20px;">
                            <div class="container-fluid">
                                <div class="map-responsive">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.5561556214234!2d109.08319967372269!3d-7.623175775373578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e656d5ef62354f1%3A0x16963b8f0cf5cab3!2sApotik%20dua%20farma!5e0!3m2!1sid!2sid!4v1705336554209!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
