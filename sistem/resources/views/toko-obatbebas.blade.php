        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <table class="table table-striped table-hover" style="font-size: smaller;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @if ($value->qty > 1)
                                    <a href="{{ url('/ubah-quantity-obatbebas?id_produk=' . $value->id_produk . '&act=minus') }}"
                                    ...
                                    <a href="{{ url('/ubah-quantity-obatbebas?id_produk=' . $value->id_produk . '&act=plus') }}"
                            ...
                            <td>
                                <a href="{{url($value->id_kasir.'/hapus-keranjang-obatbebas')}}">
                    ...
                    <form method="POST" action="{{ url('simpan-pesanan-obatbebas') }}">
                        @csrf
                        <tfoot>
                            <tr>
