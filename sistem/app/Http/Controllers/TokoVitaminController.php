...
class TokoVitaminController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('toko-vitamin', compact('produk', 'kategori', 'kasir', 'request'));
    }
    ...
    public function submit(Request $request)
    {
        ...
        if ($produk->stok < 1) {
            return redirect('/toko-vitamin')->with('error', 'Stok produk tidak mencukupi');
        }
    ...
    public function changeQuantity(Request $request)
    {
        ...
        if (!$kasir) {
            ...
            return redirect('/toko-vitamin')->with('error', 'Produk tidak ditemukan dalam keranjang belanja');
        }
