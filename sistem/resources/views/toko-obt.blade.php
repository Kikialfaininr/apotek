...
<div class="row" style="margin-top: 10px;">
    ...
    <div class="col-md-4">
        <form class="d-flex" action="{{url('toko-obt')}}" method="GET">
        ...
        <div class="col-md-8">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    @if($value->kategori->nama_kategori == 'Obat Bebas Terbatas')
                    <div class="col-md-3">
                        <div class="card" style="margin-bottom:20px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end">
                                    <form method="POST" action="{{url('keranjang-obt')}}">
                                        @csrf
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <table class="table table-striped table-hover" style="font-size: smaller;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    @if ($value->qty > 1)
                                    <a href="{{ url('/ubah-quantity-obt?id_produk=' . $value->id_produk . '&act=minus') }}"
                                    ...
                                    <a href="{{ url('/ubah-quantity-obt?id_produk=' . $value->id_produk . '&act=plus') }}"
                            ...
                            <td>
                                <a href="{{url($value->id_kasir.'/hapus-keranjang-obt')}}">
                    ...
                    <form method="POST" action="{{ url('simpan-pesanan-obt') }}">
                        @csrf
                        <tfoot>
                            <tr>
