...
<nav class="navbar sticky-bottom bg-white fixed-top">
    <div class="container-fluid" style="justify-content: center;">
        <a href="{{ url('/toko-allproduk') }}" style="{{ request()->is('toko-allproduk') ? 'color: #FFC045;' : '' }}">All</a>
        <a href="{{ url('/toko-obt') }}" style="{{ request()->is('toko-obt') ? 'color: #FFC045;' : '' }}">Obat Bebas Terbatas</a>
        <a href="{{ url('/toko-obatbebas') }}" style="{{ request()->is('toko-obatbebas') ? 'color: #FFC045;' : '' }}">Obat Bebas</a>
        <a href="{{ url('/toko-vitamin') }}" style="{{ request()->is('toko-vitamin') ? 'color: #FFC045;' : '' }}">Vitamin</a>
    </div>
</nav>
...
<div class="row" style="margin-top: 10px;">
    ...
    <div class="col-md-4">
        <form class="d-flex" action="{{url('toko-obatbebas')}}" method="GET">
        ...
        <div class="col-md-8">
            <div class="container">
                ...
                @if($produk->isEmpty())
                    ...
                    @if($value->kategori->nama_kategori == 'Obat Bebas')
                    <div class="col-md-3">
                        <div class="card" style="margin-bottom:20px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end">
                                    <form method="POST" action="{{url('keranjang-obatbebas')}}">
                                        @csrf
