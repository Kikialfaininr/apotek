...
<div class="container" align="center">
    <div class="row">
        ...
        <h5 class="text-center text-kop">Jalan Jendral Sudirman No. 6A RT 01 RW 09 Planjan, Kecamatan Kesugihan, 53274</h5>
        <h4 class="text-center text-kop">CILACAP</h4>
        <hr><br>
        <h3 class="text-center"><u>DATA KATEGORI PRODUK</u></h3>
    </div>
</div>
