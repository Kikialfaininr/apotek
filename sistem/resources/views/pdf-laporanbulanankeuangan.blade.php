...
<div class="container" align="center">
    <div class="row">
        ...
        <hr><br>
        <h3 class="text-center">LAPORAN KEUANGAN <br> <u style="text-decoration: none; border-bottom: 2px solid black;">PERIODE {{ strtoupper(\Carbon\Carbon::createFromFormat('mY', $bulan . date('Y'))->translatedFormat('F Y')) }}</u></h3>
    </div>
</div>
