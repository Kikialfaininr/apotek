        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body d-flex align-items-center">
                    <form action="{{ url('admin-penjualan') }}" method="GET" class="w-100">
                        <div class="d-flex align-items-center">
                            ...
                            @if(isset($tanggal))
                            <a href="{{ url('admin-penjualan') }}" class="btn btn-secondary ms-2">All</a>
                            @endif
                        </div>
                    </form>
                </div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="invoice" role="tabpanel"
                            ...
                            <div class="col-md-8" style="margin-bottom: 10px;">
                                <a href="{{url('downloadinvoice')}}" target="_blank">
                                ...
                                <table class="table table-responsive table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="{{url('kasir-invoice/'.$value->id_penjualan)}}" target="_blank">
                        ...
                        <div class="tab-pane fade" id="produkterjual" role="tabpanel"
                            ...
                            <div class="d-flex justify-content-end">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <li class="page-item {{ $penjualanDetail->currentPage() == 1 ? 'disabled' : '' }}">
