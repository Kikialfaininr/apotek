...
class TokoObatbebasController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('toko-obatbebas', compact('produk', 'kategori', 'kasir', 'request'));
    }
    ...
    public function submit(Request $request)
    {
        ...
        if ($produk->stok < 1) {
            return redirect('/toko-obatbebas')->with('error', 'Stok produk tidak mencukupi');
        }
        ...
        return Redirect('/toko-obatbebas'); 
    }
    ...
    public function changeQuantity(Request $request)
    {
        ...
        if (!$kasir) {
            ...
            return redirect('/toko-obatbebas')->with('error', 'Produk tidak ditemukan dalam keranjang belanja');
        }
