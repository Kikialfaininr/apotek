...
class TokoOBTController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        if ($produk->stok < 1) {
            return redirect('/toko-obt')->with('error', 'Stok produk tidak mencukupi');
        }
    ...
    public function changeQuantity(Request $request)
    {
        ...
        if (!$kasir) {
            ...
            return redirect('/toko-obt')->with('error', 'Produk tidak ditemukan dalam keranjang belanja');
        }
